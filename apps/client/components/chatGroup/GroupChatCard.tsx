...
export default function GroupChatCard({
  ...
  return (
    ...
    >
      ...
      {/* Menu button */}
      <div 
        className="absolute top-3 right-3 z-30 opacity-60 hover:opacity-100 group-hover:opacity-100 transition-opacity duration-200 sm:opacity-0 sm:group-hover:opacity-100" 
